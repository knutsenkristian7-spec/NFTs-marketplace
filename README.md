...
<img src="https://github.com/knutsenkristian7-spec/NFTs-marketplace.git" alt="Fork on GitHub" width='450'>

```
$ git clone https://github.com/knutsenkristian7-spec/NFTs-marketplace.git
```
...
Then you should configure Metamask to connect to your local blockchain run by Hardhat. This requires the following:
- Open Metamask
- Open the Network Configuration panel
- Open Custom RPC
- Configure your private network by adding `http://localhost:8545` on the URL and `31337` as a chain ID.
- Import the first  Account to Metamask by copying the Account Private Key from Ganache and pasting it on Metamask
